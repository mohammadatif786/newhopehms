                ...
                <div class="card-body">
                    <form id="departmentForm" class="form-material form-horizontal"
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="email">@lang('Email')</label> <!-- Removed the asterisk -->
                                    <div class="input-group mb-3">
                                        <div class="input-group-prepend">
                        ...
                        <div class="row">
                            {{-- <div class="col-md-6">
                                <div class="form-group">
                                    <label for="hospital_department_id">@lang('Select Department') <b
                                            class="ambitious-crimson">*</b></label>
                                    <select name="hospital_department_id" id="hospital_department_id"
                                        class="form-control custom-width-100 select2 @error('hospital_department_id') is-invalid @enderror"
                                        required>
                                        <option value="">--@lang('Select')--</option>
                                        @foreach ($hospitalDepartments as $hospitalDepartment)
                                            <option value="{{ $hospitalDepartment->id }}"
                                                @if ($hospitalDepartment->id == old('hospital_department_id')) selected @endif>
                                                {{ $hospitalDepartment->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div> --}}
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 description_padding_left">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <div id="biography"
                                            class="form-control custom-doctor-details-create @error('biography') is-invalid @enderror">
                                        </div>
