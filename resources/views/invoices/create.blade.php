                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select name="user_id" id="user_id"
                                        class="form-control custom-width-100 @error('user_id') is-invalid @enderror"
                                        required>
                                        <option value="">--@lang('Select')--</option>
                                        @foreach ($patients as $patient)
                                            {
                                            <option value="{{ $patient->id }}"
                                                @if ($patient->id == old('user_id')) selected @endif>
                            ...
                            {{-- <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select name="insurance_id" id="insurance_id"
                                        class="form-control custom-width-100 @error('insurance_id') is-invalid @enderror">
                                        <option value="">--@lang('Select')--</option>
                                        @foreach ($insurances as $insurance)
                                            {
                                            <option value="{{ $insurance->id }}"
                                                @if ($insurance->id == old('insurance_id')) selected @endif>
                                                {{ $insurance->id . '. ' . $insurance->name }}</option>
                                        @endforeach
                                    </select>
                                    @error('insurance_id')
                                        <div class="invalid-feedback">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="invoice_date" id="invoice_date"
                                        ...
                                        placeholder="@lang('Invoice Date')" value="{{ old('invoice_date', date('Y-m-d')) }}"
                                        required>
                                    @error('invoice_date')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                    ...
                                    <table id="t1" class="table">
                                                            ...
                                                            <select name="account_name[]" class="form-control" required>
                                                                ...
                                                                @foreach ($accountHeaders as $accountHeader)
                                                                    <option value="{{ $accountHeader->name }}"
                                                                        @if (old('account_name')[$key] == $accountHeader->name) selected @endif>
                                                                        {{ $accountHeader->name }}</option>
                                                                @endforeach
                                                            </select>
                                                        </td>
                                                        <td>
                                        ...
                                        <tbody id="invoice">
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="number" step=".01" name="sub_total[]"
                                                        class="form-control sub_total" value="0.00"
                                                        placeholder="@lang('Sub Total')" readonly>
                                                </td>
                                                <td>
                                                    <button type="button" class="btn btn-info m-add"><i
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-right">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="number" step=".01" name="discount_percentage"
                                                            value="{{ old('discount_percentage', '0.00') }}"
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="number" step=".01" name="total_vat"
                                                        class="form-control vat" value="{{ old('total_vat', '0.00') }}"
                                                        placeholder="@lang('Total Vat')">
                                                </td>
                                                <td></td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="number" step=".01" name="paid"
                                                        class="form-control paid" value="{{ old('paid') }}"
