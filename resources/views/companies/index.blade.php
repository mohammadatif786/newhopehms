                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="company_name" class="form-control"
                                                value="{{ request()->company_name }}" placeholder="@lang('Company Name')">
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="company_domain" class="form-control"
                                                value="{{ request()->company_domain }}" placeholder="@lang('Company Domain')">
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="company_email" class="form-control"
                                                value="{{ request()->company_email }}" placeholder="@lang('Company Email')">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                            ...
                            @foreach ($companies as $company)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @endcan
                                        @can('company-delete')
                                            <a href="#" data-href="{{ route('company.destroy', $company) }}"
