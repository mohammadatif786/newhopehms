                ...
                <div class="card-body">
                    <form class="form-material form-horizontal" action="{{ route('roles.store') }}" method="post">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <select class="form-control ambitious-form-loading @error('role_for') is-invalid @enderror"
                                    ...
                                    <option value="1" {{ old('role_for') == 1 ? 'selected' : '' }}>@lang('General User')
                                    </option>
                                    <option value="0" {{ old('role_for') == 0 ? 'selected' : '' }}>@lang('System User')
                                    </option>
                                </select>
                                @error('role_for')
                                    <div class="invalid-feedback">
                        ...
                        <div id="user_block">
                            <div class="form-group row">
                                <label class="col-md-2 col-form-label ambitious-center">
                                    <h4>@lang('Price') <b class="ambitious-crimson">*</b></h4>
                                </label>
                                <div class="col-md-8">
                            ...
                            <div class="form-group row">
                                <label class="col-md-2 col-form-label ambitious-center">
                                    <h4>@lang('Validity') <b class="ambitious-crimson">*</b></h4>
                                </label>
                                <div class="col-md-8">
                                    <input
                        ...
                        <div class="form-group row mb-0">
                            <label class="col-md-2 col-form-label ambitious-center">
                                <h4>@lang('Permissions') <b class="ambitious-crimson">*</b></h4>
                            </label>
                            <div class="col-md-10">
