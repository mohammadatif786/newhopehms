...
<aside class="main-sidebar sidebar-light-info elevation-4">
    <a href="{{ route('dashboard') }}" class="brand-link sidebar-light-info">
        <img src="{{ asset('assets/images/360_logo_fav.png') }}" alt="{{ $ApplicationSetting->item_name }}"
            ...
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                ...
                {{-- @canany(['hospital-department-read', 'hospital-department-create', 'hospital-department-update', 'hospital-department-delete'])
                    <li class="nav-item">
                        <a href="{{ route('hospital-departments.index') }}"
                            class="nav-link @if ($c == 'hospital-departments') active @endif">
                ...
                @endcanany
                   @canany(['patient-detail-read', 'patient-detail-create', 'patient-detail-update',
                    ...
                    <li class="nav-item">
                        <a href="{{ route('patient-details.create') }}"
                            class="nav-link @if (Route::currentRouteName() == 'patients.old') active @endif">
                            <i class="nav-icon fas fa-user-injured"></i>
                            <p>@lang('Add New Patients')</p>
                        </a>
                    </li>
                @endcanany
                @canany(['patient-detail-read', 'patient-detail-create', 'patient-detail-update',
                ...
                @canany(['patient-detail-read', 'patient-detail-create', 'patient-detail-update',
                    'patient-detail-delete'])
                    <li class="nav-item">
                        <a href="{{ route('patients.discharged') }}"
                            class="nav-link @if (Route::currentRouteName() == 'patients.discharged') active @endif">
                            <i class="nav-icon fas fa-user-injured"></i>
                            <p>@lang('Discharge Patient ')</p>
                        </a>
                    </li>
                @endcanany

                {{-- <a href="{{ route('patients.old') }}" class="btn btn-secondary">View Old Patients</a> --}}

                @canany(['patient-detail-read', 'patient-detail-create', 'patient-detail-update',
                    'patient-detail-delete'])
                    <li class="nav-item">
                        <a href="{{ route('patients.old') }}"
                            class="nav-link @if (Route::currentRouteName() == 'patients.old') active @endif">
                            <i class="nav-icon fas fa-user-injured"></i>
                            <p>@lang('Previous Patients')</p>
                        </a>
                    </li>
                @endcanany
                ...
                {{-- @canany(['insurance-read', 'insurance-create', 'insurance-update', 'insurance-delete'])
                    <li class="nav-item">
                        <a href="{{ route('insurances.index') }}"
                            class="nav-link @if ($c == 'insurances') active @endif">
                ...
                {{-- @canany(['front-end-read', 'front-end-create', 'front-end-update', 'front-end-delete'])
                    <li class="nav-item">
                        <a href="{{ route('front-ends.index') }}"
                            class="nav-link @if ($c == 'front-ends') active @endif">
                ...
                {{-- @canany(['contact-us-read', 'contact-us-delete'])
                    <li class="nav-item">
                        <a href="{{ route('contacts.index') }}"
                            class="nav-link @if ($c == 'contacts') active @endif">
                            ...
                            @canany(['email-template-read', 'email-template-create', 'email-template-update', 'email-template-delete'])
                                <li class="nav-item">
                                    <a href="{{ route('email-templates.index') }}"
                                        class="nav-link @if ($c == 'email-templates') active @endif ">
                            ...
                            @canany(['email-campaign-read', 'email-campaign-create', 'email-campaign-update', 'email-campaign-delete'])
                                <li class="nav-item">
                                    <a href="{{ route('email-campaigns.index') }}"
                                        class="nav-link @if ($c == 'email-campaigns') active @endif ">
                            ...
                            @canany(['sms-api-read', 'sms-api-create', 'sms-api-update', 'sms-api-delete'])
                                <li class="nav-item">
                                    <a href="{{ route('sms-apis.index') }}"
                                        class="nav-link @if ($c == 'sms-apis') active @endif ">
                            ...
                            @canany(['sms-template-read', 'sms-template-create', 'sms-template-update', 'sms-template-delete'])
                                <li class="nav-item">
                                    <a href="{{ route('sms-templates.index') }}"
                                        class="nav-link @if ($c == 'sms-templates') active @endif ">
                                        <i class="fas fa-crop-alt"></i>
                            ...
                            @canany(['sms-campaign-read', 'sms-campaign-create', 'sms-campaign-update', 'sms-campaign-delete'])
                                <li class="nav-item">
                                    <a href="{{ route('sms-campaigns.index') }}"
                                        class="nav-link @if ($c == 'sms-campaigns') active @endif ">
                                        <i class="fas fa-bullhorn"></i>
                    ...
                    <li class="nav-item has-treeview @if (
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            {{-- @canany(['smtp-read', 'smtp-create', 'smtp-update', 'smtp-delete'])
                                <li class="nav-item">
                                    <a href="{{ route('smtp-configurations.index') }}"
                                        class="nav-link @if ($c == 'smtp-configurations') active @endif ">
                            ...
                            {{-- @canany(['currencies-read', 'currencies-create', 'currencies-update', 'currencies-delete'])
                                <li class="nav-item">
                                    <a href="{{ route('currency.index') }}"
                                        class="nav-link @if ($c == 'currency') active @endif ">
                            ...
                            {{-- @canany(['tax-rate-read', 'tax-rate-create', 'tax-rate-update', 'tax-rate-delete'])
                                <li class="nav-item">
                                    <a href="{{ route('tax.index') }}"
                                        class="nav-link @if ($c == 'tax') active @endif ">
