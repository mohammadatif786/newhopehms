                ...
                <div class="card-body">
                    <form class="form-material form-horizontal" action="{{ route('prescriptions.store') }}" method="POST"
                                    ...
                                    <select name="user_id" id="user_id"
                                        ...
                                        @foreach ($patients as $patient)
                                            ...
                                            <option value="{{ $patient->id }}"
                                                @if ($patient->id == request()->user_id) selected @endif>{{ $patient->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                    @error('user_id')
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="text" id="food_allergy" name="food_allergy"
                                                    value="{{ old('food_allergy', $patientCaseStudy->food_allergy ?? null) }}"
                                                    class="form-control @error('food_allergy') is-invalid @enderror"
                                                    placeholder="@lang('Food Allergy')">
                                                @error('food_allergy')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>
                                            ...
                                            <div class="input-group mb-3">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text"><i
                                                            class="fas fa-heart-broken"></i></span>
                                                </div>
                                                <input type="text" id="heart_disease" name="heart_disease"
                                                    value="{{ old('heart_disease', $patientCaseStudy->heart_disease ?? null) }}"
                                                    class="form-control @error('heart_disease') is-invalid @enderror"
                                                    placeholder="@lang('Heart Disease')">
                                                @error('heart_disease')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="text" id="high_blood_pressure" name="high_blood_pressure"
                                                    value="{{ old('high_blood_pressure', $patientCaseStudy->high_blood_pressure ?? null) }}"
                                                    class="form-control @error('high_blood_pressure') is-invalid @enderror"
                                                    placeholder="@lang('High Blood Pressure')">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text"><i
                                                            class="fas fa-drumstick-bite"></i></span>
                                                </div>
                                                <input type="text" id="diabetic" name="diabetic"
                                                    value="{{ old('diabetic', $patientCaseStudy->diabetic ?? null) }}"
                                                    class="form-control @error('diabetic') is-invalid @enderror"
                                                    placeholder="@lang('Diabetic')">
                                                @error('diabetic')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="text" id="surgery" name="surgery"
                                                    value="{{ old('surgery', $patientCaseStudy->surgery ?? null) }}"
                                                    class="form-control @error('surgery') is-invalid @enderror"
                                                    placeholder="@lang('Surgery')">
                                                @error('surgery')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="text" id="accident" name="accident"
                                                    value="{{ old('accident', $patientCaseStudy->accident ?? null) }}"
                                                    class="form-control @error('accident') is-invalid @enderror"
                                                    placeholder="@lang('Accident')">
                                                @error('accident')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="text" id="others" name="others"
                                                    value="{{ old('others', $patientCaseStudy->others ?? null) }}"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="text" id="family_medical_history"
                                                    ...
                                                    value="{{ old('family_medical_history', $patientCaseStudy->family_medical_history ?? null) }}"
                                                    class="form-control @error('family_medical_history') is-invalid @enderror"
                                                    placeholder="@lang('Family Medical History')">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="text" id="current_medication" name="current_medication"
                                                    value="{{ old('current_medication', $patientCaseStudy->current_medication ?? null) }}"
                                                    class="form-control @error('current_medication') is-invalid @enderror"
                                                    placeholder="@lang('Current Medication')">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="text" id="pregnancy" name="pregnancy"
                                                    value="{{ old('pregnancy', $patientCaseStudy->pregnancy ?? null) }}"
                                                    class="form-control @error('pregnancy') is-invalid @enderror"
                                                    placeholder="@lang('Pregnancy')">
                                                @error('pregnancy')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="text" id="breastfeeding" name="breastfeeding"
                                                    value="{{ old('breastfeeding', $patientCaseStudy->breastfeeding ?? null) }}"
                                                    class="form-control @error('breastfeeding') is-invalid @enderror"
                                                    placeholder="@lang('Breast feeding')">
                                                @error('breastfeeding')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="text" name="health_insurance" id="health_insurance"
                                                    ...
                                                    placeholder="@lang('Health Insurance')"
                                                    value="{{ old('health_insurance', $patientCaseStudy->health_insurance ?? null) }}">
                        ...
                        <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" id="weight" name="weight" value="{{ old('weight') }}"
                                            ...
                                            placeholder="@lang('Weight (kg)')" oninput="validateWeight()">
                                        <div id="weight-error" class="invalid-feedback" style="display:none;">
                                            @lang('Please enter a valid number (e.g., 4 or 4.6) for the weight.')
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" id="height" name="height" value="{{ old('height') }}"
                                            ...
                                            placeholder="@lang('Height')" oninput="validateHeight()">
                                        <div id="height-error" class="invalid-feedback" style="display:none;">
                                            @lang('Please enter a valid number (e.g., 5 or 5.9) for the height.')
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="blood_pressure">@lang('Blood Pressure') <b
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" id="blood_pressure" name="blood_pressure"
                                            ...
                                            placeholder="@lang('Blood Pressure')">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="chief_complaint">@lang('Chief Complaint') <b
                                            class="ambitious-crimson"></b></label>
                                    <div class="input-group mb-3">
                                        <textarea name="chief_complaint" id="chief_complaint"
                                            class="form-control @error('chief_complaint') is-invalid @enderror" rows="4"
                                            placeholder="@lang('Chief Complaint')">{{ old('chief_complaint') }}</textarea>
                                            ...
                                            <tr>
                                                <td>
                                                    <input type="text" name="medicine_name[]" class="form-control"
                                                        value="" placeholder="@lang('Medicine Name')">
                                                </td>
                                                <td>
                                                    <input type="text" name="medicine_type[]" class="form-control"
                                                        value="" placeholder="@lang('Medicine Type')">
                                                </td>
                                                <td>
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody id="diagnosis">
                                            <tr>
                                                <td>
                                                    <input type="text" name="diagnosis[]" class="form-control"
                                                        value="" placeholder="@lang('Diagnosis')">
                                                </td>
                                                <td>
                                                    <input type="text" name="diagnosis_instruction[]"
...
@push('footer')
    ...
    <script>
        function validateWeight() {
            ...
            // Allow integers and decimals, like 4, 4.5, 4.65
        ...
        function validateHeight() {
            ...
            // Allow integers and decimals, like 5, 5.9, 5.99
