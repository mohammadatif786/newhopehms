                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" id="weight" name="weight"
                                            value="{{ old('weight', $prescription->weight) }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" id="height" name="height"
                                            value="{{ old('height', $prescription->height) }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" id="blood_pressure" name="blood_pressure"
                                            value="{{ old('blood_pressure', $prescription->blood_pressure) }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        <textarea name="chief_complaint" id="chief_complaint"
                                            ...
                                            placeholder="Chief Complaint">{{ old('chief_complaint', $prescription->chief_complaint) }}</textarea>
                                                ...
                                                @foreach (json_decode($prescription->medicine_info) as $medicineInfo)
                                                    <tr>
                                                        <td>
                                                            <input type="text" name="medicine_name[]"
                                                                class="form-control"
                                                                value="{{ $medicineInfo->medicine_name }}"
                                                                placeholder="Medicine Name">
                                                        </td>
                                                        <td>
                                                            <input type="text" name="medicine_type[]"
                                                                class="form-control"
                                                                value="{{ $medicineInfo->medicine_type }}"
                                                                placeholder="Medicine Type">
                                                        </td>
                                                        <td>
                                                            <input type="text" name="instruction[]"
                                                                class="form-control"
                                                                value="{{ $medicineInfo->instruction }}"
                                                                placeholder="Instructions">
                                                        </td>
                                                        <td>
                                                            <input type="text" name="day[]" class="form-control"
                                                                value="{{ $medicineInfo->day }}" placeholder="Days">
                                                        </td>
                                                        <td>
                                                            <button type="button" class="btn btn-info m-add"><i
                                                                    class="fas fa-plus"></i></button>
                                            ...
                                            <tr>
                                                <td>
                                                    <input type="text" name="medicine_name[]" class="form-control"
                                                        value="" placeholder="Medicine Name">
                                                </td>
                                                <td>
                                                    <input type="text" name="medicine_type[]" class="form-control"
                                                        value="" placeholder="Medicine Type">
                                                </td>
                                                <td>
                                    ...
                                    <table class="table">
                                                ...
                                                @foreach (json_decode($prescription->diagnosis_info) as $diagnosisInfo)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="text" name="diagnosis_instruction[]"
                                                                class="form-control"
                                                                value="{{ $diagnosisInfo->diagnosis_instruction }}"
                                                                placeholder="Instruction">
                                                        </td>
                                                        <td>
                                                            <button type="button" class="btn btn-info d-add"><i
                                        ...
                                        <tbody id="diagnosis">
                                            <tr>
                                                <td>
                                                    <input type="text" name="diagnosis[]" class="form-control"
                                                        value="" placeholder="Diagnosis">
                                                </td>
                                                <td>
                                                    <input type="text" name="diagnosis_instruction[]"
                                                        class="form-control" value="" placeholder="Instruction">
                                                </td>
                                                <td>
                                                    <button type="button" class="btn btn-info d-add"><i
                                                            class="fas fa-plus"></i></button>
